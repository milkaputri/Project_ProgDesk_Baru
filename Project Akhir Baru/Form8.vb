    ...
    Public Sub TampilDataTambahan()
        ...
        If myDataReader.HasRows Then
            While myDataReader.Read()
                ...
                DataGridViewTambahan.Item(0, i).Value = myDataReader("nama_paket")
                DataGridViewTambahan.Item(1, i).Value = myDataReader("nama_paket")
                DataGridViewTambahan.Item(2, i).Value = jumlah
                DataGridViewTambahan.Item(3, i).Value = myDataReader("id_paket")
                i = i + 1
            End While
            'Dim totalPengeluaran As Integer = 0
            'For Each row As DataGridViewRow In DataGridViewPaket.Rows
